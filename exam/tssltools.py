...
def logweight_fun_wrong(particles, y, sigma_eta):
	...
	"""
	return - 1/2 * (particles - y)**2 / (sigma_eta**2)


def propagate_wrong(particles, sigma_eps):
	"""Function for propagating the particles
	...
	return 0.8 * particles + sigma_eps * np.random.randn(len(particles)) 
